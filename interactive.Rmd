...
The motivation for this component is to allow a user to select features through a series of buttons and view what crime statistics look like geographically.

This chapter uses a package, ggmap:
