...
#Data has been pre-filtered to keep the overall size small and manageable when plotting
...
## Interactive Map of Crime Around Columbia
  ...
  <p>Please select an option below to filter points on the map and refresh the page to reset</p>
  Victim Gender: 
