...
plt <- ggplot(df_counts) + geom_bar(aes(y=CRIME_CAT, x=total_count), stat="identity",fill = "cornflowerblue")+
...
df_key_fields %>%
  ...
  ggplot(aes(x = freq, y = fct_reorder(OFNS_DESC, freq), color = CRIME_CAT)) +
